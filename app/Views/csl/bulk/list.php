...
<?php   foreach($list as $no => $val) { ?>
                                        <tr>
                                            <td><?=$val->list_no ?></td>
                                            <td><a href="/csl/bulk/detail/<?=$val->b_idx ?>"><?=$val->title ?></a></td>
...
<script>
    ...
    $(function() {
        ...
        $("#write").click(function(e) {
            location.href = "/csl/bulk/excel/write";
        });
    });
    ...
    function search() {
        ...
        var rows = $("#rows").val();
        location.href = "/csl/bulk/list?page=1&search_text="+search_text+"&search_condition="+search_condition+"&rows="+rows;
    }
</script>