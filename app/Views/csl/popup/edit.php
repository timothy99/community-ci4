                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="file" class="form-control" id="popup_file" name="popup_file" onchange="upload(this.id)">
                                    </div>
                                    <div class="col-sm-5">
                                        <ul class="list-unstyled" id="popup_file_visible">
<?php   if ($info->popup_file_info != null) { ?>
                                            <li id="<?=$info->popup_file_info->file_id ?>">
                                                <a href="/csl/file/download/<?=$info->popup_file_info->file_id ?>"><?=$info->popup_file_info->file_name_org ?></a>
